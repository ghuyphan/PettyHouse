  ...
  resources: {
    en: {
      translations: {
        ...
        registrationSuccessMessage: 'Welcome to Mapmee! Your account has been successfully registered!', 
        ...
        locationPermissionTitle: 'Mapmee needs Location Access',
        ...
        save: 'Save',
        confirmExit: 'Unsaved changes?',
        unsavedChanges: 'Are you sure you want to exit without saving, all changes will be lost?',
        no:'Cancel',
        yes:'Discard',
    ...
    vi: {
      translations: {
        ...
        unsupportedImageFormat: 'Định dạng hình ảnh không được hỗ trợ',
        ...
        errorFetchingData: 'Lỗi trong quá trình tìm kiếm',
        error: 'Lỗi',
        explore: 'Khám phá',
        inbox: 'Hộp thư',
        create: 'Tạo mới',
        ...
        personalInformation: 'Thông tin cá nhân',
        ...
        confirmExit: 'Thay đổi chưa lưu',
        unsavedChanges: 'Có thay đổi chưa lưu. Bạn có muốn thoát?',
        no: 'Huỷ',
        yes: 'Thoát',
        findingAddress: 'Đang tìm địa chỉ...',
