  ...
  resources: {
    en: {
      translations: {
        ...
        locationPermissionContent: 'To display pets nearby, please grant location access.',
    ...
    vi: {
      translations: {
        ...
        locationPermissionTitle: 'Petty House cần quyền truy cập vị trí',
        locationPermissionContent: 'Để hiển thị thú cưng ở gần bạn, vui lòng cấp quyền truy cập vị trí.',
